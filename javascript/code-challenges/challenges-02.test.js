...
const raisedToTheThird = (arr) => {
  let newArray = [];
  arr.forEach(value => newArray.push(Math.pow(value, 3)));
  return newArray;
};
...
const addOne = (arr) => {
  let newArray = arr.map( (value, i) => {return value + 1});
  return newArray;
};
...
const addQuestion = (arr) => {
  let newArray = arr.map( (value, i) => {return value + '?'});
  return newArray;
};
...
const mapTwoToThe = (arr) => {
  let newArray = arr.map( (value, i) => Math.pow(2, value)); 
  return newArray;
};
