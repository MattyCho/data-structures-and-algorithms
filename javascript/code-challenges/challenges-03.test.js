...
const typeNum = (arr) => {
  let newArray = arr.filter( value => Number.isInteger(value));
  return newArray
};
...
const containsAnd = (arr) => {
  let newArray = arr.filter( value => value.includes ('and'));
  return newArray;
};
...
const oddValues = (arr) => {
  let newArray = arr.filter( value => (value % 2))
  return newArray;
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  let newArray = arr.filter( value => !forbiddenValues.includes(value));
  return newArray;
};
